...
A successful Phase 3 Week 2 run reports 18 passing tests across three files:
...
- `test_sampling.py` (Week 3): collection-level sampler retains every failure-bearing collection and preserves the joint `(priority_tier, scheduling_class)` distribution within 2%.
